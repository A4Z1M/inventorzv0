(function ($) {
	...
	document.addEventListener('DOMContentLoaded', function() {
		const formBox = document.querySelector('.hero-form-box');
		if (!formBox) return;
		...
		document.addEventListener('mousemove', function(e) {
			...
			const translateX = (deltaX / centerX) * maxTranslation;
			const translateY = (deltaY / centerY) * maxTranslation;
		...
		document.addEventListener('mouseleave', function() {
			formBox.style.transform = 'perspective(1000px) rotateX(0) rotateY(0) translateX(0) translateY(0)';
		});
	});
})(jQuery);
